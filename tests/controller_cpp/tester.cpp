...
Tester::Tester(string outFile, unsigned long nbTests)
{
    ...
    m_nbTests=nbTests;
    m_outFile << "Inst[16] Flags[4] Clk[1] Reset[1] Carry[1] DP_Shift[1] Imm32_Enable[1] Imm5[5] Imm32[32] ALU_Opcode[4] Rm[3] Rn[3] Rd[3] RAM_Addr[32] Load[1] Store[1] PC[8]" << endl << endl;
